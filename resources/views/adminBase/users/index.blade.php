...
<div class="row">
    <div class="col-12">
        <div class="card m-b-30">
            <div class="card-body">
                <a href="{{ route('users.create') }}"><button type="button" class="btn btn-primary waves-effect waves-light" style="margin-bottom: 25px;" >Create New Users</button></a>
                            ...
                            <td>
                                ...
                                <div class="dropdown mo-mb-2">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        <a class="dropdown-item edit-category" href="{{ route('users.edit',$user->id) }}" style="color: white;">
